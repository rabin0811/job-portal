...
namespace JobPortal.Services.Implementation
{
    public class JobService : IJobService
    {
        ...
        public async Task<List<Job>> GetAllJobsAsync(string? search = null, string? jobType = null, string? location = null)
        {
            ...
            return await query.OrderByDescending(j => j.IssueDate).ToListAsync();
        }
